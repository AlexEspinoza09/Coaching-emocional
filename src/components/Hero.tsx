      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight">
            ...
            <span className="block text-primary-200 mt-2">con Coaching Emocional</span>
          </h1>

          <p className="mt-6 max-w-2xl mx-auto text-xl sm:text-2xl text-primary-100">
            Descubre el poder de tus emociones y alcanza el bienestar que mereces.
            Sesiones personalizadas que te ayudarán a gestionar el estrés, mejorar tus relaciones
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#contact"
              className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold rounded-lg bg-white text-primary-700 hover:bg-primary-50 transition-all duration-200 transform hover:scale-105 shadow-lg"
            >
